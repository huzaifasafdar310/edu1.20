...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variantStyles = {
        ...
        secondary: { bg: COLORS.primaryGhost, text: COLORS.primary, border: 'transparent' },
                ...
                style={[
                    {
                        ...
                        ...(variant === 'primary' && !disabled ? SHADOWS.colored : {}),
                    },
                    style,
                ]}
            >
        ...
        <View style={[{ marginBottom: 16 }, style]}>
            ...
            <View style={[
                ...
                <TextInput
                    style={[
                        styles.input,
                        multiline && { height: numberOfLines * 24 + 16, textAlignVertical: 'top', paddingTop: 12 },
                        icon ? { paddingLeft: 10 } : { paddingLeft: 16 },
                    ]}
    ...
    <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 16 }}>
        ...
        {action && (
            <TouchableOpacity onPress={action.onPress}>
                <Text style={{ color: COLORS.primary, fontSize: SIZES.fontSm, fontWeight: '600' }}>
                    {action.label}
                </Text>
            </TouchableOpacity>
        )}
...
export const Badge: React.FC<{
    ...
    bgColor?: string;
    size?: 'sm' | 'md';
}> = ({ label, color = COLORS.primary, bgColor = COLORS.primaryGhost, size = 'md' }) => (
    <View style={{
...
export const LoadingOverlay: React.FC<{ message?: string }> = ({ message = 'Thinking...' }) => (
    <View style={styles.loadingOverlay}>
        <View style={styles.loadingBox}>
            ...
            <Text style={styles.loadingSubtext}>Powered by Groq</Text>
        </View>
    </View>
);
...
export const EmptyState: React.FC<{
    ...
    <View style={styles.emptyState}>
        <View style={styles.emptyIconBg}>
            <MaterialIcons name={icon as any} size={36} color={COLORS.primary} />
        </View>
        <Text style={styles.emptyTitle}>{title}</Text>
        {subtitle && <Text style={styles.emptySubtitle}>{subtitle}</Text>}
        {action && (
            <Button title={action.label} onPress={action.onPress} size="sm" style={{ marginTop: 20 }} />
        )}
    </View>
);
    ...
    return (
        <View style={{
            ...
            <View style={{
                ...
                padding: 14,
                ...(!isUser ? SHADOWS.sm : SHADOWS.colored),
            }}>
                <Text style={{
...
export const NoApiKeyBanner: React.FC<{ onPress: () => void }> = ({ onPress }) => (
    <TouchableOpacity onPress={onPress} style={styles.apiKeyBanner}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
            ...
            <Text style={{ color: COLORS.textSecondary, fontSize: 12, marginTop: 2 }}>
                Tap to add your free Groq API key to unlock all features
            </Text>
        </View>
